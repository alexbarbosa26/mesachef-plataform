...
| 0005 | `0005-autenticacao-sessoes-tokens.md` | `PROPOSED` | Sessão opaca revogável no servidor para a aplicação web |
| 0006 | `0006-isolamento-multiempresa-rbac.md` | `PROPOSED` | Membership multiempresa, RBAC e isolamento em profundidade |
